        ...
        <div className="mt-12 bg-primary/5 p-8 rounded-lg">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Access to favorable interest rates from multiple lenders to
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Streamlined application and approval process with minimal
            ...
            <div>
              <h3 className="font-semibold mb-2">Expert Guidance</h3>
              <p className="text-muted-foreground">
                Professional advice on loan selection, tax implications, and
