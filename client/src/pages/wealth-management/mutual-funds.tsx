          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Research-driven recommendations tailored to your risk profile
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Strategic asset allocation to maximize returns while managing
                risk effectively.
              </p>
            </div>
            <div>
              ...
              <p className="text-muted-foreground">
                Regular performance reviews and rebalancing to ensure alignment
