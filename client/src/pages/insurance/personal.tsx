        ...
        <div className="mt-12 bg-primary/5 p-8 rounded-lg">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Insurance plans tailored to your specific needs, lifestyle, and
                budget.
              </p>
            </div>
            <div>
              ...
              <p className="text-muted-foreground">
                Protection against financial hardships during unexpected life
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Dedicated assistance throughout the claims process to ensure a
                smooth experience.
              </p>
            </div>
          </div>
