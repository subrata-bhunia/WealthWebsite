export const NAVIGATION_ITEMS = {
  ...
  lease: {
    label: "Lease",
    items: [
      { title: "New Car", href: "/lease/new-car" },
  ...
  loans: {
    label: "Loans",
    items: [
      { title: "Home Loan", href: "/loans/home-loan" },
      { title: "Loan Against Property", href: "/loans/loan-against-property" },
      { title: "Loan Against Rent", href: "/loans/loan-against-rent" },
      { title: "Loan Against Shares/MF", href: "/loans/loan-against-shares" },
      { title: "Gold Loan", href: "/loans/gold-loan" },
